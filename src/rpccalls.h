...
{
// declare struct in ultrapoint's cryptonote namespace.
// ultrapoint should provide definition for this,
...
public:
    ...
    rpccalls(string _deamon_url = "http:://127.0.0.1:17080",
    ...
    get_alt_blocks(vector<string>& alt_blocks_hashes)
    {
        ...
        if (r)
        {
            ...
            if (!err.empty())
            {
                cerr << "Error connecting to Ultrapoint deamon due to "
                     << err << endl;
                return false;
            }
        }
        ...
        {
            cerr << "Error connecting to Ultrapoint deamon at "
                 << deamon_url << endl;
            return false;
        }
