 ...
 */
    ...
    public:
                        ...
                        bool tx_prove = false)
        {
            ...
            {
                return string("Ultrapoint address not provided!");
            }
...
//                                << endl;
        ...
        show_checkrawtx(string raw_tx_data, string action)
        {
            ...
            else
            {
                ...
                if (strncmp(decoded_raw_tx_data.c_str(), SIGNED_TX_PREFIX, magiclen) != 0)
                {
                    ...
                    // used in myultrapoint and openultrapoint projects.
        ...
        search(string search_text)
        {
            ...
            // check if ultrapoint address is given based on its length
            ...
            // check if integrated ultrapoint address is given based on its length
        ...
        json_rawtransaction(string tx_hash_str)
        {
            ...
            // get raw tx json as in ultrapoint
     ...
     */
                     ...
                     bool tx_prove = false)
        {
            ...
            {
                j_response["status"]  = "error";
                j_response["message"] = "Cant parse ultrapoint address: " + address_str;
                return j_response;
        ...
        json_networkinfo()
        {
            ...
            {
                j_response["status"]  = "error";
                j_response["message"] = "Cant get ultrapoint network info";
                return j_response;
            }
