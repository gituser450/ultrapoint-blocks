...
main(int ac, const char* av[])
{
    ...
    if (testnet && deamon_url == "http:://127.0.0.1:17080")
    {
        deamon_url = "http:://127.0.0.1:27080";
    }
    ...
    ([&](const crow::request& req) {
        ...
        {
            return string("up address, viewkey or tx hash not provided");
        }
    ...
    CROW_ROUTE(app, "/prove").methods("POST"_method)
        ([&](const crow::request& req) {
            ...
            {
                return string("up address, tx private key or "
